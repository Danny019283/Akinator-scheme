...
(define conocimiento
  '((leon        (mamifero si)(salvaje si)(carnivoro si)(tiene-pelo si)(grande si)(vive-en-sabana si)(rapido si)(tiene-cola si))
    ...
    (aguila      (ave si)(salvaje si)(carnivoro si)(tiene-plumas si)(vuela si)(grande si)(rapido si)(tiene-cola si)(tiene-pelo no))
    (loro        (ave si)(domestico si)(omnivoro si)(tiene-plumas si)(vuela si)(pequeno si)(vive-en-selva si)(tiene-cola si)(tiene-pelo no))
    (pinguino    (ave si)(salvaje si)(carnivoro si)(tiene-plumas si)(nada si)(vuela no)(vive-en-agua si)(grande no)(tiene-pelo no))
    (serpiente   (reptil si)(salvaje si)(carnivoro si)(tiene-escamas si)(venenoso si)(tiene-cola si)(vive-en-selva si)(rapido no)(tiene-pelo no))
    (cocodrilo   (reptil si)(salvaje si)(carnivoro si)(tiene-escamas si)(grande si)(vive-en-agua si)(tiene-cola si)(nada si)(tiene-pelo no))
    (tortuga     (reptil si)(salvaje si)(herbivoro si)(tiene-escamas si)(rapido no)(tiene-cola si)(vive-en-agua si)(pequeno si)(tiene-pelo no))
    (iguana      (reptil si)(salvaje si)(herbivoro si)(tiene-escamas si)(tiene-cola si)(vive-en-selva si)(pequeno si)(rapido no)(tiene-pelo no))
    (tiburon     (pez si)(salvaje si)(carnivoro si)(tiene-escamas si)(nada si)(grande si)(vive-en-agua si)(rapido si)(tiene-pelo no))
    (delfin      (mamifero si)(salvaje si)(carnivoro si)(nada si)(vive-en-agua si)(grande si)(tiene-cola si)(rapido si)(tiene-pelo no))
    (ballena     (mamifero si)(salvaje si)(carnivoro si)(nada si)(vive-en-agua si)(grande si)(tiene-cola si)(rapido no)(tiene-pelo no))
    (rana        (anfibio si)(salvaje si)(carnivoro si)(vive-en-agua si)(pequeno si)(nada si)(tiene-cola no)(rapido si)(tiene-pelo no))
    (sapo        (anfibio si)(salvaje si)(carnivoro si)(vive-en-agua si)(pequeno si)(nocturno si)(venenoso si)(rapido no)(tiene-pelo no))
    (abeja       (insecto si)(salvaje si)(herbivoro si)(vuela si)(pequeno si)(venenoso si)(rapido si)(tiene-cola no)(tiene-pelo no))
    (mariposa    (insecto si)(salvaje si)(herbivoro si)(vuela si)(pequeno si)(rapido no)(vive-en-selva si)(tiene-cola no)(tiene-pelo no))
    (hormiga     (insecto si)(salvaje si)(omnivoro si)(pequeno si)(vuela no)(rapido no)(domestico no)(tiene-cola no)(tiene-pelo no))
